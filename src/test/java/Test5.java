   ...
   @Test
    public void Test5() {
        ...
        if (sitev==0) {
            ...
            //close notification that overlay our main page
        ...
        String usercurrlang = Locale.getDefault().toString();


        switch (usercurrlang) {
            case "uk_UA": gflocname = "Хрещений батько";
                break;
            case "en_US":
            case "en_UK": gflocname = "The Godfather";
                break;
            case "ru_RU": gflocname = "Крестный отец";
                break;
            ...
            WebElement gflink = driver.findElement(By.linkText(gflocname));
            gflink.click();
